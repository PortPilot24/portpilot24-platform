...
public class PostController {
    ...
    //게시글등록
    // @PostMapping
    // public void insertPost(@RequestPart("post") PostDTO postDTO,
    ...
    //     // Hibernate 사용하여 postDto → Entity 저장
    //     PostEntity post = postService.insertPost(postDTO);
...
//    }
    ...
    public void fileUpload(@RequestParam(value = "files", required = false) List<MultipartFile> files, 
